      ...
      <div className="container">
         ...
         <nav className="navbar navbar-expand-lg navbar-light">
            ...
            <div className="collapse navbar-collapse style-navbar" id="navbarNavAltMarkup">
               <a className="navbar-brand d-none d-lg-block" href="/"><img src={process.env.PUBLIC_URL + 'images/logo_blue.png'} width="100" alt="logo_blue" loading="lazy" /></a>
               <div className="navbar-nav text-uppercase mx-auto lead py-0 pl-5">
                  <Link to={'/'} className="nav-item nav-link text-danger d-none d-lg-block pl-5 px-4">Home</Link>           
                  <a className="nav-item nav-link d-none d-lg-block pl-4" href="#about">About</a>  
